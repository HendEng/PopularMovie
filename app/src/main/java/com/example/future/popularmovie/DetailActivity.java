...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        if(i.hasExtra("myfilm")) {
            aflamko aflam = i.getParcelableExtra("myfilm");
            Log.i("movie intent re", aflam== null?"yes":aflam.getID());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(this, SittingActivity.class);
            startActivity(i);
            return true;
        }
